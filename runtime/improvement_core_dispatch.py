...
current cumulative-autonomous ImprovementCore regime. When no substantive
target/job/basis is supplied, the dispatcher first runs governed zero-request
observation over the supplied corpus and creates only a discovery seed. The
normal ImprovementCore controller then owns substantive work generation.
"""
