...
This module converts an addressable corpus into a governed, observation-first
seed for the normal ImprovementCore controller. It does not solve the user's
substantive problem before controller entry. It creates only a typed discovery
job whose purpose is to let the controller discover the live improvement
frontier from the supplied corpus.
"""
