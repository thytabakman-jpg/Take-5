...
from representation_discovery import generate_views,candidate_universe,compare_discovery,CandidateUniverse
...
def regenerate(state,view_generators,candidate_generators,prior_views=(),prior_universe=None,relation_changed=False,state_changed=False):
    ...
    if prior_universe is None:
        if prior_views:
            ...
            prior_universe=CandidateUniverse(tuple(candidate_generators.keys()),())
